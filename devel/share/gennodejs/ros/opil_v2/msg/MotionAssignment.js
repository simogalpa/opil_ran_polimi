...
class MotionAssignment {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Id.serialize(obj.point_id, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.point_id = Id.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += Id.getMessageSize(object.point_id);
  ...
  static Resolve(msg) {
    ...
    if (msg.point_id !== undefined) {
      resolved.point_id = Id.Resolve(msg.point_id)
    }
    else {
      resolved.point_id = new Id()
    }
