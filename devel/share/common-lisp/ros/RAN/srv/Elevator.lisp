...
(cl:defmethod cl:initialize-instance :after ((m <Elevator-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Elevator-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RAN-srv:<Elevator-request> is deprecated: use RAN-srv:Elevator-request instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <Elevator-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RAN-srv:action-val is deprecated.  Use RAN-srv:action instead.")
  (action m))

(cl:ensure-generic-function 'desired_floor-val :lambda-list '(m))
(cl:defmethod desired_floor-val ((m <Elevator-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RAN-srv:desired_floor-val is deprecated.  Use RAN-srv:desired_floor instead.")
  (desired_floor m))
...
(cl:defmethod cl:initialize-instance :after ((m <Elevator-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Elevator-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RAN-srv:<Elevator-response> is deprecated: use RAN-srv:Elevator-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Elevator-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RAN-srv:success-val is deprecated.  Use RAN-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <Elevator-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RAN-srv:message-val is deprecated.  Use RAN-srv:message instead.")
  (message m))
