...
(cl:defmethod cl:initialize-instance :after ((m <ActionAssignment>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActionAssignment)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opil_v2-msg:<ActionAssignment> is deprecated: use opil_v2-msg:ActionAssignment instead.")))
