...
(cl:defmethod cl:initialize-instance :after ((m <ErrorAGV>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ErrorAGV)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opil_v2-msg:<ErrorAGV> is deprecated: use opil_v2-msg:ErrorAGV instead.")))
...
(cl:defmethod error_AGV-val ((m <ErrorAGV>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opil_v2-msg:error_AGV-val is deprecated.  Use opil_v2-msg:error_AGV instead.")
  (error_AGV m))
