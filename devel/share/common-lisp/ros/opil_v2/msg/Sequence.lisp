...
(cl:defmethod cl:initialize-instance :after ((m <Sequence>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sequence)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opil_v2-msg:<Sequence> is deprecated: use opil_v2-msg:Sequence instead.")))

(cl:ensure-generic-function 'sequence_number-val :lambda-list '(m))
(cl:defmethod sequence_number-val ((m <Sequence>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opil_v2-msg:sequence_number-val is deprecated.  Use opil_v2-msg:sequence_number instead.")
  (sequence_number m))

(cl:ensure-generic-function 'length-val :lambda-list '(m))
(cl:defmethod length-val ((m <Sequence>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opil_v2-msg:length-val is deprecated.  Use opil_v2-msg:length instead.")
  (length m))
