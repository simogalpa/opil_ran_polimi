...
(cl:defclass <RANState> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (agv_msg
    :reader agv_msg
    :initarg :agv_msg
    :type opil_v2-msg:RobotState
    :initform (cl:make-instance 'opil_v2-msg:RobotState))
   (ran_status
    :reader ran_status
    :initarg :ran_status
    :type cl:fixnum
...
(cl:defmethod cl:initialize-instance :after ((m <RANState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RANState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opil_v2-msg:<RANState> is deprecated: use opil_v2-msg:RANState instead.")))
...
(cl:defmethod ran_status-val ((m <RANState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opil_v2-msg:ran_status-val is deprecated.  Use opil_v2-msg:ran_status instead.")
  (ran_status m))
