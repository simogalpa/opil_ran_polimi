...
(cl:defmethod cl:initialize-instance :after ((m <AssignmentId>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AssignmentId)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sim_msgs-msg:<AssignmentId> is deprecated: use sim_msgs-msg:AssignmentId instead.")))

(cl:ensure-generic-function 'task_id-val :lambda-list '(m))
(cl:defmethod task_id-val ((m <AssignmentId>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sim_msgs-msg:task_id-val is deprecated.  Use sim_msgs-msg:task_id instead.")
  (task_id m))

(cl:ensure-generic-function 'action_id-val :lambda-list '(m))
(cl:defmethod action_id-val ((m <AssignmentId>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sim_msgs-msg:action_id-val is deprecated.  Use sim_msgs-msg:action_id instead.")
  (action_id m))

(cl:ensure-generic-function 'motion_id-val :lambda-list '(m))
(cl:defmethod motion_id-val ((m <AssignmentId>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sim_msgs-msg:motion_id-val is deprecated.  Use sim_msgs-msg:motion_id instead.")
  (motion_id m))
