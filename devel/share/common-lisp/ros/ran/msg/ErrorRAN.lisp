...
(cl:defclass <ErrorRAN> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (agv_error
    :reader agv_error
    :initarg :agv_error
    :type ran-msg:ErrorAGV
    :initform (cl:make-instance 'ran-msg:ErrorAGV)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ErrorRAN>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ErrorRAN)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ran-msg:<ErrorRAN> is deprecated: use ran-msg:ErrorRAN instead.")))
...
(cl:defmethod error_RAN-val ((m <ErrorRAN>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:error_RAN-val is deprecated.  Use ran-msg:error_RAN instead.")
  (error_RAN m))
...
(cl:defmethod agv_error-val ((m <ErrorRAN>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:agv_error-val is deprecated.  Use ran-msg:agv_error instead.")
  (agv_error m))
