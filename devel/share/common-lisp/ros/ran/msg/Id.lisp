...
(cl:defmethod cl:initialize-instance :after ((m <Id>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Id)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ran-msg:<Id> is deprecated: use ran-msg:Id instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Id>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:id-val is deprecated.  Use ran-msg:id instead.")
  (id m))
