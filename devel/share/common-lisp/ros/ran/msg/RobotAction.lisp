...
(cl:defclass <RobotAction> (roslisp-msg-protocol:ros-message)
  ((category
   ...
   (attributes
    :reader attributes
    :initarg :attributes
    :type (cl:vector ran-msg:Tuple)
   :initform (cl:make-array 0 :element-type 'ran-msg:Tuple :initial-element (cl:make-instance 'ran-msg:Tuple)))
   (description
    :reader description
    :initarg :description
    :type cl:string
...
(cl:defmethod cl:initialize-instance :after ((m <RobotAction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotAction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ran-msg:<RobotAction> is deprecated: use ran-msg:RobotAction instead.")))

(cl:ensure-generic-function 'category-val :lambda-list '(m))
(cl:defmethod category-val ((m <RobotAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:category-val is deprecated.  Use ran-msg:category instead.")
  (category m))
...
(cl:defmethod attributes-val ((m <RobotAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:attributes-val is deprecated.  Use ran-msg:attributes instead.")
  (attributes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RobotAction>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'attributes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ran-msg:Tuple))
