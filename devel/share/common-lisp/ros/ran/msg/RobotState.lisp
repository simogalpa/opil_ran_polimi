...
(cl:defclass <RobotState> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (last_terminated_action
    ...
    :type ran-msg:AssignmentId
    :initform (cl:make-instance 'ran-msg:AssignmentId))
   (robot_status
    :reader robot_status
...
(cl:defmethod cl:initialize-instance :after ((m <RobotState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ran-msg:<RobotState> is deprecated: use ran-msg:RobotState instead.")))
...
(cl:defmethod last_terminated_action-val ((m <RobotState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:last_terminated_action-val is deprecated.  Use ran-msg:last_terminated_action instead.")
...
(cl:defmethod robot_status-val ((m <RobotState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:robot_status-val is deprecated.  Use ran-msg:robot_status instead.")
  (robot_status m))

(cl:ensure-generic-function 'battery_state-val :lambda-list '(m))
(cl:defmethod battery_state-val ((m <RobotState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:battery_state-val is deprecated.  Use ran-msg:battery_state instead.")
  (battery_state m))

(cl:ensure-generic-function 'current_position-val :lambda-list '(m))
(cl:defmethod current_position-val ((m <RobotState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:current_position-val is deprecated.  Use ran-msg:current_position instead.")
  (current_position m))

(cl:ensure-generic-function 'current_velocity-val :lambda-list '(m))
(cl:defmethod current_velocity-val ((m <RobotState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:current_velocity-val is deprecated.  Use ran-msg:current_velocity instead.")
  (current_velocity m))

(cl:ensure-generic-function 'footprint-val :lambda-list '(m))
(cl:defmethod footprint-val ((m <RobotState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:footprint-val is deprecated.  Use ran-msg:footprint instead.")
  (footprint m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RobotState>)))
  ...
  "d674ccffd58e40ba6cdf28a33363f064")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RobotState)))
  "Returns md5sum for a message object of type 'RobotState"
  "d674ccffd58e40ba6cdf28a33363f064")
