...
(cl:defclass <RANState> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
   ...
   (agv_msg
    :reader agv_msg
    :initarg :agv_msg
    :type ran-msg:RobotState
    :initform (cl:make-instance 'ran-msg:RobotState))
   (ran_status
    :reader ran_status
    :initarg :ran_status
    :type cl:fixnum
...
(cl:defclass RANState (<RANState>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <RANState>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'RANState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ran-msg:<RANState> is deprecated: use ran-msg:RANState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <RANState>))
...
(cl:defmethod robot_id-val ((m <RANState>))
...
(cl:defmethod agv_msg-val ((m <RANState>))
...
(cl:ensure-generic-function 'ran_status-val :lambda-list '(m))
(cl:defmethod ran_status-val ((m <RANState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:ran_status-val is deprecated.  Use ran-msg:ran_status instead.")
  (ran_status m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<RANState>)))
    "Constants for message type '<RANState>"
  '((:READY . 0)
    (:MOVING . 1)
    (:STOPPED . 2))
)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RANState>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'ran_status)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RANState>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RANState>))
  "Converts a ROS message object to a list"
  (cl:list 'RANState
    (cl:cons ':header (header msg))
    (cl:cons ':robot_id (robot_id msg))
    (cl:cons ':agv_msg (agv_msg msg))
    (cl:cons ':ran_status (ran_status msg))
))
