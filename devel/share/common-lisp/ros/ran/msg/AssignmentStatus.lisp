...
(cl:defclass <AssignmentStatus> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (assignment_queue
    ...
    :type (cl:vector ran-msg:AssignmentId)
   :initform (cl:make-array 0 :element-type 'ran-msg:AssignmentId :initial-element (cl:make-instance 'ran-msg:AssignmentId)))
   (footprint
    :reader footprint
    :initarg :footprint
...
(cl:defmethod cl:initialize-instance :after ((m <AssignmentStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AssignmentStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ran-msg:<AssignmentStatus> is deprecated: use ran-msg:AssignmentStatus instead.")))
...
(cl:defmethod current_task_id-val ((m <AssignmentStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:current_task_id-val is deprecated.  Use ran-msg:current_task_id instead.")
  (current_task_id m))

(cl:ensure-generic-function 'current_motion_id-val :lambda-list '(m))
(cl:defmethod current_motion_id-val ((m <AssignmentStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:current_motion_id-val is deprecated.  Use ran-msg:current_motion_id instead.")
  (current_motion_id m))

(cl:ensure-generic-function 'current_action_id-val :lambda-list '(m))
(cl:defmethod current_action_id-val ((m <AssignmentStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:current_action_id-val is deprecated.  Use ran-msg:current_action_id instead.")
  (current_action_id m))
...
(cl:defmethod last_finished_motion-val ((m <AssignmentStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:last_finished_motion-val is deprecated.  Use ran-msg:last_finished_motion instead.")
...
(cl:defmethod last_finished_action-val ((m <AssignmentStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:last_finished_action-val is deprecated.  Use ran-msg:last_finished_action instead.")
...
(cl:defmethod assignment_queue-val ((m <AssignmentStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ran-msg:assignment_queue-val is deprecated.  Use ran-msg:assignment_queue instead.")
  (assignment_queue m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AssignmentStatus>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'assignment_queue)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ran-msg:AssignmentId))
