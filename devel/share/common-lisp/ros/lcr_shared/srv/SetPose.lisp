...
(cl:defmethod cl:initialize-instance :after ((m <SetPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lcr_shared-srv:<SetPose-request> is deprecated: use lcr_shared-srv:SetPose-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <SetPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lcr_shared-srv:pose-val is deprecated.  Use lcr_shared-srv:pose instead.")
  (pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lcr_shared-srv:<SetPose-response> is deprecated: use lcr_shared-srv:SetPose-response instead.")))
