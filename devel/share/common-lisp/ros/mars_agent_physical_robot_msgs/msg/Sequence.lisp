...
(cl:defmethod cl:initialize-instance :after ((m <Sequence>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sequence)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mars_agent_physical_robot_msgs-msg:<Sequence> is deprecated: use mars_agent_physical_robot_msgs-msg:Sequence instead.")))

(cl:ensure-generic-function 'sequence_number-val :lambda-list '(m))
(cl:defmethod sequence_number-val ((m <Sequence>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mars_agent_physical_robot_msgs-msg:sequence_number-val is deprecated.  Use mars_agent_physical_robot_msgs-msg:sequence_number instead.")
  (sequence_number m))

(cl:ensure-generic-function 'length-val :lambda-list '(m))
(cl:defmethod length-val ((m <Sequence>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mars_agent_physical_robot_msgs-msg:length-val is deprecated.  Use mars_agent_physical_robot_msgs-msg:length instead.")
  (length m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Sequence>)))
  ...
  "mars_agent_physical_robot_msgs/Sequence")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Sequence)))
  "Returns string type for a message object of type 'Sequence"
  "mars_agent_physical_robot_msgs/Sequence")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Sequence>)))
  ...
  (cl:format cl:nil "# Message for defining a sequence.~%~%# Actual position in the sequence. The sequence starts at 1! ~%int32 sequence_number~%# Overall lenght of the sequence~%int32 length~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Sequence)))
  "Returns full string definition for message of type 'Sequence"
  (cl:format cl:nil "# Message for defining a sequence.~%~%# Actual position in the sequence. The sequence starts at 1! ~%int32 sequence_number~%# Overall lenght of the sequence~%int32 length~%~%~%"))
