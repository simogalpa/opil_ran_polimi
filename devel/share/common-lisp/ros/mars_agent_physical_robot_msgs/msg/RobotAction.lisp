...
(cl:defclass <RobotAction> (roslisp-msg-protocol:ros-message)
  ((category
   ...
   (attributes
    :reader attributes
    :initarg :attributes
    :type (cl:vector mars_common_msgs-msg:Tuple)
   :initform (cl:make-array 0 :element-type 'mars_common_msgs-msg:Tuple :initial-element (cl:make-instance 'mars_common_msgs-msg:Tuple)))
   (description
    :reader description
    :initarg :description
    :type cl:string
...
(cl:defmethod cl:initialize-instance :after ((m <RobotAction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotAction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mars_agent_physical_robot_msgs-msg:<RobotAction> is deprecated: use mars_agent_physical_robot_msgs-msg:RobotAction instead.")))

(cl:ensure-generic-function 'category-val :lambda-list '(m))
(cl:defmethod category-val ((m <RobotAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mars_agent_physical_robot_msgs-msg:category-val is deprecated.  Use mars_agent_physical_robot_msgs-msg:category instead.")
  (category m))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <RobotAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mars_agent_physical_robot_msgs-msg:action-val is deprecated.  Use mars_agent_physical_robot_msgs-msg:action instead.")
  (action m))

(cl:ensure-generic-function 'attributes-val :lambda-list '(m))
(cl:defmethod attributes-val ((m <RobotAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mars_agent_physical_robot_msgs-msg:attributes-val is deprecated.  Use mars_agent_physical_robot_msgs-msg:attributes instead.")
  (attributes m))

(cl:ensure-generic-function 'description-val :lambda-list '(m))
(cl:defmethod description-val ((m <RobotAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mars_agent_physical_robot_msgs-msg:description-val is deprecated.  Use mars_agent_physical_robot_msgs-msg:description instead.")
  (description m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RobotAction>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'attributes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'mars_common_msgs-msg:Tuple))
