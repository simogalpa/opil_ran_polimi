...
"""autogenerated by genpy from opil_v2/RobotState.msg. Do not edit."""
import sys
...
class RobotState(genpy.Message):
  _md5sum = "d674ccffd58e40ba6cdf28a33363f064"
  _type = "opil_v2/RobotState"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','opil_v2/Id','opil_v2/AssignmentId','industrial_msgs/RobotStatus','sensor_msgs/BatteryState','geometry_msgs/Pose2D','geometry_msgs/Twist','geometry_msgs/PolygonStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.last_terminated_action is None:
        self.last_terminated_action = opil_v2.msg.AssignmentId()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_6I().pack(_x.last_terminated_action.task_id, _x.last_terminated_action.action_id, _x.last_terminated_action.motion_id, _x.robot_status.header.seq, _x.robot_status.header.stamp.secs, _x.robot_status.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.last_terminated_action.task_id, _x.last_terminated_action.action_id, _x.last_terminated_action.motion_id, _x.robot_status.header.seq, _x.robot_status.header.stamp.secs, _x.robot_status.header.stamp.nsecs,) = _get_struct_6I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
