...
"""autogenerated by genpy from opil_v2/RobotDescriptionAGV.msg. Do not edit."""
import sys
...
class RobotDescriptionAGV(genpy.Message):
  _md5sum = "800c3c6d6616acec91eaf106544798b5"
  _type = "opil_v2/RobotDescriptionAGV"
...
"""
  __slots__ = ['header','vehicle_id','left_size','right_size','front_size','rear_size','min_height','max_height','payload','max_pos_x_vel','max_neg_x_vel','max_pos_x_acc','max_neg_x_acc','max_pos_y_vel','max_neg_y_vel','max_pos_y_acc','max_neg_y_acc','max_pos_ang_vel','max_neg_ang_vel','velocity_control_sensitivity','min_turning_radius','batt_capacity','batt_max_voltage','vehicle_type','vendor','action_capability']
  _slot_types = ['std_msgs/Header','opil_v2/Id','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','string','string','opil_v2/RobotAction[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,vehicle_id,left_size,right_size,front_size,rear_size,min_height,max_height,payload,max_pos_x_vel,max_neg_x_vel,max_pos_x_acc,max_neg_x_acc,max_pos_y_vel,max_neg_y_vel,max_pos_y_acc,max_neg_y_acc,max_pos_ang_vel,max_neg_ang_vel,velocity_control_sensitivity,min_turning_radius,batt_capacity,batt_max_voltage,vehicle_type,vendor,action_capability
