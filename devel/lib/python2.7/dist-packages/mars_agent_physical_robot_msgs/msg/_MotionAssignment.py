...
"""autogenerated by genpy from mars_agent_physical_robot_msgs/MotionAssignment.msg. Do not edit."""
import sys
...
class MotionAssignment(genpy.Message):
  _md5sum = "d4c5a46f20a838c5a572e0f81ed1d96f"
  _type = "mars_agent_physical_robot_msgs/MotionAssignment"
...
"""
  ...
  _slot_types = ['std_msgs/Header','mars_common_msgs/Id','mars_common_msgs/Id','mars_common_msgs/Id','mars_common_msgs/Id','geometry_msgs/Pose2D','bool','bool','geometry_msgs/Twist','geometry_msgs/Accel','geometry_msgs/PolygonStamped','mars_agent_physical_robot_msgs/Sequence']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.point_id is None:
        self.point_id = mars_common_msgs.msg.Id()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.point_id.uuid = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
