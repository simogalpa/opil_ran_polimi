// Generated by gencpp from file sim_msgs/AssignmentId.msg
// DO NOT EDIT!


#ifndef SIM_MSGS_MESSAGE_ASSIGNMENTID_H
#define SIM_MSGS_MESSAGE_ASSIGNMENTID_H
...
struct AssignmentId_
{
  ...
  typedef boost::shared_ptr< ::sim_msgs::AssignmentId_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sim_msgs::AssignmentId_<ContainerAllocator> const> ConstPtr;

}; // struct AssignmentId_

typedef ::sim_msgs::AssignmentId_<std::allocator<void> > AssignmentId;

typedef boost::shared_ptr< ::sim_msgs::AssignmentId > AssignmentIdPtr;
typedef boost::shared_ptr< ::sim_msgs::AssignmentId const> AssignmentIdConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sim_msgs::AssignmentId_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sim_msgs::AssignmentId_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sim_msgs::AssignmentId_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sim_msgs::AssignmentId_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sim_msgs::AssignmentId_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sim_msgs::AssignmentId_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sim_msgs::AssignmentId_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sim_msgs::AssignmentId_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sim_msgs::AssignmentId_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sim_msgs::AssignmentId_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4202b775afdccaf8ULL;
  static const uint64_t static_value2 = 0x86a80f2adcd776faULL;
};

template<class ContainerAllocator>
struct DataType< ::sim_msgs::AssignmentId_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sim_msgs::AssignmentId_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sim_msgs::AssignmentId_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sim_msgs::AssignmentId_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sim_msgs::AssignmentId_<ContainerAllocator>& v)
  {
    s << indent << "task_id: ";
    s << std::endl;
...
#endif // SIM_MSGS_MESSAGE_ASSIGNMENTID_H
