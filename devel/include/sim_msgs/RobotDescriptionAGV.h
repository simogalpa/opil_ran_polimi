// Generated by gencpp from file sim_msgs/RobotDescriptionAGV.msg
// DO NOT EDIT!


#ifndef SIM_MSGS_MESSAGE_ROBOTDESCRIPTIONAGV_H
#define SIM_MSGS_MESSAGE_ROBOTDESCRIPTIONAGV_H
...
struct RobotDescriptionAGV_
{
  ...
  typedef boost::shared_ptr< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> const> ConstPtr;

}; // struct RobotDescriptionAGV_

typedef ::sim_msgs::RobotDescriptionAGV_<std::allocator<void> > RobotDescriptionAGV;

typedef boost::shared_ptr< ::sim_msgs::RobotDescriptionAGV > RobotDescriptionAGVPtr;
typedef boost::shared_ptr< ::sim_msgs::RobotDescriptionAGV const> RobotDescriptionAGVConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbfb2343bc38ab59eULL;
  static const uint64_t static_value2 = 0x121647c30a480bf2ULL;
};

template<class ContainerAllocator>
struct DataType< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sim_msgs::RobotDescriptionAGV_<ContainerAllocator>& v)
  {
    s << indent << "left_size: ";
...
#endif // SIM_MSGS_MESSAGE_ROBOTDESCRIPTIONAGV_H
