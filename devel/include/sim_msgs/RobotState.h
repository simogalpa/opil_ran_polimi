// Generated by gencpp from file sim_msgs/RobotState.msg
// DO NOT EDIT!


#ifndef SIM_MSGS_MESSAGE_ROBOTSTATE_H
#define SIM_MSGS_MESSAGE_ROBOTSTATE_H
...
struct RobotState_
{
  ...
  _vehicle_id_type vehicle_id;
   ...
   typedef  ::sim_msgs::AssignmentId_<ContainerAllocator>  _last_terminated_action_type;
  ...
  typedef boost::shared_ptr< ::sim_msgs::RobotState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sim_msgs::RobotState_<ContainerAllocator> const> ConstPtr;

}; // struct RobotState_

typedef ::sim_msgs::RobotState_<std::allocator<void> > RobotState;

typedef boost::shared_ptr< ::sim_msgs::RobotState > RobotStatePtr;
typedef boost::shared_ptr< ::sim_msgs::RobotState const> RobotStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sim_msgs::RobotState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sim_msgs::RobotState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sim_msgs::RobotState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sim_msgs::RobotState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sim_msgs::RobotState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sim_msgs::RobotState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sim_msgs::RobotState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sim_msgs::RobotState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sim_msgs::RobotState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sim_msgs::RobotState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x45226de6e5930fb9ULL;
  static const uint64_t static_value2 = 0x3f540273f2dbf9abULL;
};

template<class ContainerAllocator>
struct DataType< ::sim_msgs::RobotState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sim_msgs::RobotState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sim_msgs::RobotState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sim_msgs::RobotState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sim_msgs::RobotState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << std::endl;
    Printer< ::sim_msgs::AssignmentId_<ContainerAllocator> >::stream(s, indent + "  ", v.last_terminated_action);
...
#endif // SIM_MSGS_MESSAGE_ROBOTSTATE_H
