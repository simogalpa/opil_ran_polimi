// Generated by gencpp from file RAN/RobotState.msg
// DO NOT EDIT!


#ifndef RAN_MESSAGE_ROBOTSTATE_H
#define RAN_MESSAGE_ROBOTSTATE_H
...
struct RobotState_
{
  ...
  _vehicle_id_type vehicle_id;
   ...
   typedef  ::RAN::AssignmentId_<ContainerAllocator>  _last_terminated_action_type;
  ...
  typedef boost::shared_ptr< ::RAN::RobotState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::RAN::RobotState_<ContainerAllocator> const> ConstPtr;

}; // struct RobotState_

typedef ::RAN::RobotState_<std::allocator<void> > RobotState;

typedef boost::shared_ptr< ::RAN::RobotState > RobotStatePtr;
typedef boost::shared_ptr< ::RAN::RobotState const> RobotStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::RAN::RobotState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::RAN::RobotState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::RAN::RobotState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::RAN::RobotState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::RAN::RobotState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::RAN::RobotState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::RAN::RobotState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::RAN::RobotState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::RAN::RobotState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::RAN::RobotState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x45226de6e5930fb9ULL;
  static const uint64_t static_value2 = 0x3f540273f2dbf9abULL;
};

template<class ContainerAllocator>
struct DataType< ::RAN::RobotState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::RAN::RobotState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::RAN::RobotState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::RAN::RobotState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::RAN::RobotState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << std::endl;
    Printer< ::RAN::AssignmentId_<ContainerAllocator> >::stream(s, indent + "  ", v.last_terminated_action);
...
#endif // RAN_MESSAGE_ROBOTSTATE_H
