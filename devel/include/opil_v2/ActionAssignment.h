// Generated by gencpp from file opil_v2/ActionAssignment.msg
// DO NOT EDIT!


#ifndef OPIL_V2_MESSAGE_ACTIONASSIGNMENT_H
#define OPIL_V2_MESSAGE_ACTIONASSIGNMENT_H
...
struct ActionAssignment_
{
  ...
  typedef boost::shared_ptr< ::opil_v2::ActionAssignment_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::opil_v2::ActionAssignment_<ContainerAllocator> const> ConstPtr;

}; // struct ActionAssignment_

typedef ::opil_v2::ActionAssignment_<std::allocator<void> > ActionAssignment;

typedef boost::shared_ptr< ::opil_v2::ActionAssignment > ActionAssignmentPtr;
typedef boost::shared_ptr< ::opil_v2::ActionAssignment const> ActionAssignmentConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::opil_v2::ActionAssignment_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::opil_v2::ActionAssignment_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::opil_v2::ActionAssignment_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::opil_v2::ActionAssignment_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::opil_v2::ActionAssignment_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::opil_v2::ActionAssignment_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::opil_v2::ActionAssignment_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::opil_v2::ActionAssignment_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::opil_v2::ActionAssignment_<ContainerAllocator> >
{
  ...
  static const char* value(const ::opil_v2::ActionAssignment_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd11a7051f7451d30ULL;
  static const uint64_t static_value2 = 0xfd8096793b2c7256ULL;
};

template<class ContainerAllocator>
struct DataType< ::opil_v2::ActionAssignment_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::opil_v2::ActionAssignment_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::opil_v2::ActionAssignment_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::opil_v2::ActionAssignment_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::opil_v2::ActionAssignment_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OPIL_V2_MESSAGE_ACTIONASSIGNMENT_H
